...
- Analytics Domain (spending trends, budgets)
- AI Insights Domain (natural language queries, reports)
...
│                      API Layer (tRPC v11)                        │
│  ┌──────────────┐  ┌──────────────┐  ┌──────────────────────┐   │
│  │  Auth Router │  │ Transaction  │  │  Rewards Router      │   │
│  │  (SIWE)      │  │    Router    │  │  (Cashback)          │   │
│  └──────────────┘  └──────────────┘  └──────────────────────┘   │
│                                                                  │
│  ┌──────────────┐                                                │
│  │ Pricing      │                                                │
...
│                     External Services                            │
│  ┌──────────────┐  ┌──────────────┐  ┌──────────────────────┐   │
│  │ Gnosis Pay   │  │  CoinGecko   │  │  Gnosis Chain        │   │
│  │    API       │  │     API      │  │  (via Wagmi/RPC)     │   │
│  └──────────────┘  └──────────────┘  └──────────────────────┘   │
└─────────────────────────────────────────────────────────────────┘
```
...
### Analytics Domain
- **Spending Analytics**: Track spending patterns over time
- **Budget Management**: Set and monitor spending budgets
- **Trend Analysis**: Identify spending trends and anomalies
- **Category Insights**: Deep dive into category-level spending

### AI Insights Domain
- **Natural Language Queries**: Ask questions about your transactions in plain English
  - "How much did I spend on groceries last month?"
  - "Show me all transactions over €100"
- **Automated Reports**: Monthly spending summaries with insights
- **Anomaly Detection**: Flag unusual transactions or spending patterns
- **Personalized Tips**: AI-generated financial advice based on spending habits

### Additional Integrations
- **OpenAI API**: For natural language processing and insights generation
- **Notification System**: Real-time alerts for large transactions, budgets, etc.
